...
export const centers = [
  ...
  { id: 'landspitali-neurological-rehabilitation-k2-reykjavik', name: 'Landspitali Neurological Rehabilitation K2', country: 'Iceland', city: 'Reykjavik', region: 'Capital Region', lat: 64.1470, lng: -21.9496, address: 'Tungata 26, 101 Reykjavik', phone: '+354 543 1000', url: 'https://island.is/en/o/landspitali/neurological-rehabilitation-k2/k2-services', conditions: ['neuromotor', 'cognitive'], technologies: [], modes: ['inpatient'], access: ['public'], disciplines: ['Neurological rehabilitation', 'Geriatric medicine', 'Specialist consultations', 'Therapy'], completeness: 88, researchHighlights: ['Official Landspitali service page identifies K2 as a neurological rehabilitation unit for people needing continued rehabilitation or medical treatment after serious illness.', 'The unit supports patients with complex health needs and reduced physical or cognitive function, with an activity- and participation-focused inpatient programme.'], features: ['university-hospital', 'neurological-rehabilitation', 'inpatient-rehab'], description: { it: 'Unita pubblica di riabilitazione neurologica di Landspitali a Reykjavik per persone con bisogni clinici complessi e riduzione della funzione fisica o cognitiva.', en: 'A public Landspitali neurological rehabilitation unit in Reykjavik for people with complex clinical needs and reduced physical or cognitive function.' } },
  { id: 'reykjalundur-neurological-rehabilitation-mosfellsbaer', name: 'Reykjalundur Neurological Rehabilitation', country: 'Iceland', city: 'Mosfellsbaer', region: 'Capital Region', lat: 64.1836, lng: -21.6936, address: 'Reykjalundur, 270 Mosfellsbaer', phone: '+354 585 2000', url: 'https://english.reykjalundur.is/treatment/', conditions: ['stroke', 'tbi', 'ms', 'parkinson', 'epilepsy', 'cognitive', 'neuromotor'], technologies: [], modes: ['inpatient', 'outpatient'], access: ['public'], disciplines: ['Neurological rehabilitation', 'Rehabilitation medicine', 'Occupational therapy', 'Psychology', 'Speech therapy', 'Physical therapy'], completeness: 94, researchHighlights: ['Official Reykjalundur programme page lists neurological rehabilitation among its interdisciplinary rehabilitation areas, delivered to inpatients and outpatients.', 'Official Reykjalundur research material describes neurorehabilitation for multiple sclerosis, Parkinson disease, epilepsy, stroke and brain injury, including cognitive rehabilitation.'], features: ['specialist-rehabilitation-centre', 'neurological-rehabilitation', 'stroke-rehab', 'brain-injury', 'multiple-sclerosis'], description: { it: 'Centro specialistico pubblico a Mosfellsbaer con programma interdisciplinare di riabilitazione neurologica per ictus, lesione cerebrale, SM, Parkinson ed epilessia.', en: 'A public specialist centre in Mosfellsbaer with an interdisciplinary neurological rehabilitation programme for stroke, brain injury, MS, Parkinson disease and epilepsy.' } }
  ,
  { id: 'dr-borivoje-gnjatic-neurological-hospital-stari-slankamen', name: 'Dr Borivoje Gnjatic Special Hospital for Neurological Diseases and Post-traumatic Conditions', country: 'Serbia', city: 'Stari Slankamen', region: 'Vojvodina', lat: 45.1450, lng: 20.2600, address: 'Dr Borivoja Gnjatica 50-52, 22329 Stari Slankamen', phone: 'Unknown', url: 'https://www.bolnicaslankamen.co.rs/kontakt/?pismo=cir', conditions: ['stroke', 'tbi', 'neuromotor', 'cognitive'], technologies: [], modes: ['inpatient'], access: ['public'], disciplines: ['Neurological rehabilitation', 'Post-traumatic rehabilitation', 'Physical medicine and rehabilitation'], completeness: 88, researchHighlights: ['The official hospital site identifies Dr Borivoje Gnjatic as a special hospital for neurological diseases and post-traumatic conditions.', 'Serbia’s official rehabilitation-network listing identifies the hospital as a 295-bed rehabilitation provider for neurological diseases.'], features: ['specialist-neurological-hospital', 'neurological-rehabilitation', 'post-traumatic-rehabilitation'], description: { it: 'Ospedale pubblico specialistico a Stari Slankamen per malattie neurologiche e condizioni post-traumatiche, con riabilitazione degenziale.', en: 'A public specialist hospital in Stari Slankamen for neurological diseases and post-traumatic conditions, with inpatient rehabilitation.' } }
  ,
  { id: 'special-hospital-cerebral-palsy-developmental-neurology-belgrade', name: 'Special Hospital for Cerebral Palsy and Developmental Neurology', country: 'Serbia', city: 'Belgrade', region: 'Belgrade', lat: 44.7763, lng: 20.4512, address: 'Sokobanjska 17a, 11000 Belgrade', phone: '+381 11 2667755', url: 'https://sbcprn.com/en/about-us/', conditions: ['cerebral-palsy', 'neuromotor', 'cognitive'], technologies: [], modes: ['inpatient', 'outpatient'], access: ['public'], disciplines: ['Developmental neurology', 'Cerebral palsy rehabilitation', 'Physiotherapy', 'Occupational therapy', 'Speech therapy'], completeness: 89, researchHighlights: ['Official hospital site states that it is dedicated to habilitating children with cerebral palsy and to early diagnosis of cerebral palsy and neurodevelopmental conditions.', 'Serbia’s Ministry of Health identifies it as the Special Hospital for Cerebral Palsy and Developmental Neurology.'], features: ['paediatric-neurorehabilitation', 'cerebral-palsy', 'developmental-neurology'], description: { it: 'Ospedale pubblico specialistico di Belgrado per abilitazione e riabilitazione di bambini con paralisi cerebrale e condizioni del neurosviluppo.', en: 'A public specialist Belgrade hospital for habilitation and rehabilitation of children with cerebral palsy and neurodevelopmental conditions.' } }
  ,
  { id: 'novi-pazar-progressive-muscular-neuromuscular-hospital', name: 'Novi Pazar Special Hospital for Progressive Muscular and Neuromuscular Diseases', country: 'Serbia', city: 'Novi Pazar', region: 'Raska District', lat: 43.1270, lng: 20.5200, address: 'Banjski Put, Novi Pazar', phone: 'Unknown', url: 'https://www.eng.rfzo.rs/index.php/healthfacilitiesserbia', conditions: ['neuromuscular', 'neuromotor', 'cognitive'], technologies: [], modes: ['inpatient'], access: ['public'], disciplines: ['Neuromuscular rehabilitation', 'Physical medicine and rehabilitation', 'Neurology'], completeness: 84, researchHighlights: ['Serbia’s official rehabilitation-network listing identifies this as a 100-bed rehabilitation provider for neurological diseases.', 'The official Serbian Health Insurance Fund facility directory identifies the specialist hospital and links its official website.'], features: ['specialist-neuromuscular-hospital', 'neuromuscular-rehabilitation', 'inpatient-rehab'], description: { it: 'Ospedale pubblico specialistico di Novi Pazar per malattie muscolari progressive e neuromuscolari con riabilitazione degenziale.', en: 'A public specialist hospital in Novi Pazar for progressive muscular and neuromuscular diseases with inpatient rehabilitation.' } }
  ,
  { id: 'ukc-tuzla-neurological-rehabilitation', name: 'University Clinical Centre Tuzla Neurological Rehabilitation Department', country: 'Bosnia and Herzegovina', city: 'Tuzla', region: 'Tuzla Canton', lat: 44.5313, lng: 18.7038, address: 'Trnovac bb, Tuzla', phone: '+387 35 303500', url: 'https://www.ukctuzla.ba/ukctuzla/?lang=bs&page_id=490', conditions: ['stroke', 'tbi', 'spinal', 'ms', 'parkinson', 'neuromuscular', 'cerebral-palsy', 'neuromotor', 'cognitive'], technologies: [], modes: ['inpatient', 'outpatient'], access: ['public'], disciplines: ['Neurological rehabilitation', 'Physical medicine and rehabilitation', 'Neurology', 'Speech therapy', 'Occupational therapy', 'Psychology'], completeness: 96, researchHighlights: ['Official UKC Tuzla page identifies a dedicated neurological rehabilitation department with an interdisciplinary team.', 'The programme treats stroke, brain injury, Parkinson disease, multiple sclerosis, polyneuropathy, neuromuscular disorders and adults with cerebral palsy.'], features: ['university-clinical-centre', 'neurological-rehabilitation', 'stroke-rehab', 'brain-injury', 'spinal-cord', 'multiple-sclerosis'], description: { it: 'Reparto pubblico universitario di Tuzla per riabilitazione neurologica interdisciplinare dopo ictus, trauma cranico, lesione midollare, SM, Parkinson e malattie neuromuscolari.', en: 'A public university department in Tuzla for interdisciplinary neurological rehabilitation after stroke, brain injury, spinal injury, MS, Parkinson disease and neuromuscular disorders.' } }
  ,
  { id: 'kantonalna-bolnica-zenica-neurological-rehabilitation', name: 'Kantonalna Hospital Zenica Neurological Rehabilitation Unit', country: 'Bosnia and Herzegovina', city: 'Zenica', region: 'Zenica-Doboj Canton', lat: 44.2077, lng: 17.9077, address: 'Crkvice 67, 72000 Zenica', phone: '+387 32 447000', url: 'https://kbze.ba/odjeli/odjel-fizikalne-medicine-i-rehabilitacije/', conditions: ['stroke', 'spinal', 'neuromuscular', 'cerebral-palsy', 'neuromotor', 'cognitive'], technologies: [], modes: ['inpatient', 'outpatient'], access: ['public'], disciplines: ['Neurological rehabilitation', 'Physical medicine and rehabilitation', 'Occupational therapy', 'Physiotherapy', 'Paediatric rehabilitation'], completeness: 92, researchHighlights: ['Official Kantonalna Hospital Zenica page lists a neurological-patient rehabilitation unit within its physical medicine and rehabilitation department.', 'The service includes rehabilitation after stroke, for neuromuscular disorders, after neurosurgery, and for children with delayed psychomotor development.'], features: ['public-hospital', 'neurological-rehabilitation', 'stroke-rehab', 'neuromuscular-rehabilitation'], description: { it: 'Unita pubblica di Zenica per riabilitazione neurologica dopo ictus, condizioni neuromuscolari, neurochirurgia e disturbi dello sviluppo psicomotorio.', en: 'A public Zenica unit for neurological rehabilitation after stroke, neuromuscular conditions, neurosurgery and psychomotor developmental disorders.' } }
  ,
  { id: 'skbm-mostar-neuropsychological-rehabilitation', name: 'University Clinical Hospital Mostar Neuropsychological Rehabilitation Service', country: 'Bosnia and Herzegovina', city: 'Mostar', region: 'Herzegovina-Neretva Canton', lat: 43.3433, lng: 17.8060, address: 'Ulica Kralja Tvrtka bb, 88000 Mostar', phone: '+387 36 336000', url: 'https://www.skbm.ba/organizacijske-jedinice/odjel-za-klinicku-zdravstvenu-i-organizacijsku-psihologiju/o-nama/', conditions: ['cognitive', 'neuromotor'], technologies: [], modes: ['inpatient', 'outpatient'], access: ['public'], disciplines: ['Neuropsychological assessment', 'Cognitive rehabilitation', 'Clinical psychology', 'Neurological rehabilitation'], completeness: 84, researchHighlights: ['Official University Clinical Hospital Mostar page lists cognitive training and neurorehabilitation among the clinical psychology department’s services.', 'The service provides neuropsychological assessment and treatment for children, adolescents and adults in a university hospital setting.'], features: ['university-clinical-hospital', 'neuropsychological-rehabilitation', 'cognitive-rehabilitation'], description: { it: 'Servizio pubblico universitario di Mostar di valutazione neuropsicologica, allenamento cognitivo e neuroriabilitazione per bambini e adulti.', en: 'A public university hospital service in Mostar for neuropsychological assessment, cognitive training and neurorehabilitation for children and adults.' } }
  ,
  { id: 'spitex-inpatient-neurorehabilitation-bijeljina', name: 'SPITEX Inpatient Neurorehabilitation Clinic', country: 'Bosnia and Herzegovina', city: 'Bijeljina', region: 'Republika Srpska', lat: 44.7565, lng: 19.2160, address: 'Ljeskovac 12b, 76300 Bijeljina', phone: '+387 55 415719', url: 'https://spitex.ba/', conditions: ['stroke', 'neuromotor', 'cognitive'], technologies: ['robotic-rehabilitation'], modes: ['inpatient'], access: ['private'], disciplines: ['Neurological rehabilitation', 'Robotic rehabilitation', 'Physiotherapy', 'Nursing'], completeness: 89, researchHighlights: ['Official SPITEX clinic page identifies a private inpatient clinic specialised in neurorehabilitation after stroke.', 'The official programme includes specialist clinical care, a rehabilitation robotics room and a 40-bed inpatient capacity.'], features: ['private-neurorehabilitation-clinic', 'inpatient-rehab', 'stroke-rehab', 'robotic-rehabilitation'], description: { it: 'Clinica privata degenziale a Bijeljina specializzata in neuroriabilitazione dopo ictus, con robotica riabilitativa.', en: 'A private inpatient clinic in Bijeljina specialised in post-stroke neurorehabilitation with rehabilitation robotics.' } }
  ,
  { id: 'dr-nenezic-neurological-rehabilitation-podgorica', name: 'Dr Nenezic Neurological Rehabilitation', country: 'Montenegro', city: 'Podgorica', region: 'Podgorica Capital City', lat: 42.4417, lng: 19.2435, address: 'City Kvart L3-9, Podgorica', phone: '+382 67 834191', url: 'https://drnenezic.me/service/neuroloska-rehabilitacija/', conditions: ['stroke', 'tbi', 'ms', 'parkinson', 'cognitive', 'neuromotor'], technologies: [], modes: ['outpatient'], access: ['private'], disciplines: ['Neurological rehabilitation', 'Physical medicine and rehabilitation', 'Speech therapy', 'Physiotherapy'], completeness: 87, researchHighlights: ['Official Dr Nenezic programme page describes specialised neurological rehabilitation for central and peripheral nervous-system disorders and injuries.', 'The service specifically describes rehabilitation after stroke, multiple sclerosis, traumatic brain injury and Parkinson disease, including speech therapy for communication impairment.'], features: ['specialist-neurological-rehabilitation', 'outpatient-rehab', 'stroke-rehab', 'brain-injury', 'multiple-sclerosis'], description: { it: 'Servizio privato specialistico a Podgorica di riabilitazione neurologica ambulatoriale per ictus, trauma cranico, sclerosi multipla e Parkinson.', en: 'A specialist private outpatient neurological rehabilitation service in Podgorica for stroke, brain injury, multiple sclerosis and Parkinson disease.' } }
  ,
  { id: 'laser-med-neurological-rehabilitation-skopje', name: 'Laser Med Neurological Rehabilitation', country: 'North Macedonia', city: 'Skopje', region: 'Skopje', lat: 41.9888, lng: 21.4583, address: 'Metodija Shatorov-Sharlo 15/1-10, Aerodrom, 1000 Skopje', phone: '+389 2 2466021', url: 'https://lasermed.com.mk/services/%D0%BD%D0%B5%D0%B2%D1%80%D0%BE%D0%BB%D0%BE%D1%88%D0%BA%D0%B0-%D1%80%D0%B5%D1%85%D0%B0%D0%B1%D0%B8%D0%BB%D0%B8%D1%82%D0%B0%D1%86%D0%B8%D1%98%D0%B0/', conditions: ['stroke', 'tbi', 'ms', 'parkinson', 'neuromuscular', 'cognitive', 'neuromotor'], technologies: [], modes: ['outpatient'], access: ['private'], disciplines: ['Neurological rehabilitation', 'Physical therapy', 'Kinesiotherapy'], completeness: 88, researchHighlights: ['Official Laser Med service page describes neurological rehabilitation for central and peripheral nervous-system disorders, targeting sensorimotor and cognitive deficits.', 'The programme specifically lists traumatic brain injury, stroke, multiple sclerosis, Parkinson disease, balance disorders and peripheral nerve paresis.'], features: ['specialist-neurological-rehabilitation', 'outpatient-rehab', 'stroke-rehab', 'brain-injury', 'multiple-sclerosis'], description: { it: 'Centro privato specialistico di Skopje per riabilitazione neurologica ambulatoriale in ictus, trauma cranico, sclerosi multipla, Parkinson e paresi periferiche.', en: 'A specialist private outpatient centre in Skopje for neurological rehabilitation in stroke, brain injury, multiple sclerosis, Parkinson disease and peripheral paresis.' } }
  ,
  { id: 'qsut-neurophysiological-rehabilitation-unit-tirana', name: 'Mother Teresa University Hospital Neurophysiological Rehabilitation Unit', country: 'Albania', city: 'Tirana', region: 'Tirana County', lat: 41.3426, lng: 19.8372, address: 'Rruga e Dibres 372, Tirana', phone: '+355 4 2362641', url: 'https://www.qsut.gov.al/blog-grid/page/6/', conditions: ['stroke', 'tbi', 'spinal', 'neuromuscular', 'cognitive', 'neuromotor'], technologies: [], modes: ['inpatient', 'outpatient'], access: ['public'], disciplines: ['Neurophysiological rehabilitation', 'Neurological rehabilitation', 'Physiotherapy', 'Physical medicine and rehabilitation'], completeness: 89, researchHighlights: ['Official Mother Teresa University Hospital material identifies a Neurophysiological Rehabilitation Unit within its Rehabilitation Clinic.', 'Official hospital information describes a physical rehabilitation service for people with neurological diseases and supports early recovery in the neurological hospital.'], features: ['university-hospital', 'neurophysiological-rehabilitation', 'neurological-rehabilitation'], description: { it: 'Unita pubblica di riabilitazione neurofisiologica presso l ospedale universitario Nene Tereza di Tirana, per pazienti con malattie neurologiche.', en: 'A public neurophysiological rehabilitation unit at Mother Teresa University Hospital in Tirana for people with neurological disease.' } }
  ,
  { id: 'barleti-neurological-rehabilitation-tirana', name: 'Barleti Neurological Rehabilitation', country: 'Albania', city: 'Tirana', region: 'Tirana County', lat: 41.3249, lng: 19.8183, address: 'Rruga Kristo Luarasi, Lake View Residences, Kulla E, Tirana', phone: '+355 8003535', url: 'https://agjenci.al/rehabilitim-neurologjik/', conditions: ['stroke', 'ms', 'parkinson', 'alzheimer', 'cognitive', 'neuromotor'], technologies: [], modes: ['home'], access: ['private'], disciplines: ['Neurological rehabilitation', 'Neurology', 'Physiotherapy', 'Speech therapy', 'Psychotherapy'], completeness: 90, researchHighlights: ['Official Barleti programme page describes multidisciplinary neurological rehabilitation for Alzheimer disease, Parkinson disease, multiple sclerosis and post-stroke consequences.', 'The service combines neurologists, physiotherapists and psychotherapists with speech therapy and home-based support.'], features: ['multidisciplinary-neurorehabilitation', 'home-neurorehabilitation', 'stroke-rehab', 'multiple-sclerosis', 'parkinson'], description: { it: 'Servizio privato multidisciplinare a Tirana di riabilitazione neurologica domiciliare per ictus, Alzheimer, Parkinson e sclerosi multipla.', en: 'A private multidisciplinary, home-based neurological rehabilitation service in Tirana for stroke, Alzheimer disease, Parkinson disease and multiple sclerosis.' } },
  { id: 'moldova-ministry-health-clinical-hospital-neurological-rehabilitation', name: 'Moldova Ministry of Health Clinical Hospital Neurological Rehabilitation', country: 'Moldova', city: 'Chisinau', region: 'Chisinau Municipality', lat: 47.0289, lng: 28.8331, address: 'Strada A. Puskin 51, Chisinau', phone: '+373 22 267047', url: 'https://scms.md/servicii/servicii-medicale/reabilitarea/reabilitarea-neurologica.html', conditions: ['stroke', 'tbi', 'spinal', 'ms', 'parkinson', 'neuromuscular', 'cognitive', 'neuromotor'], technologies: [], modes: ['inpatient', 'outpatient'], access: ['public'], disciplines: ['Neurological rehabilitation', 'Neurology', 'Physical medicine and rehabilitation', 'Occupational therapy', 'Speech therapy', 'Psychology'], completeness: 96, researchHighlights: ['Official Ministry of Health Clinical Hospital page describes neurological rehabilitation for stroke, brain and spinal trauma, post-neurosurgical patients, neuromuscular disease, Parkinson disease and multiple sclerosis.', 'The programme is delivered by a multidisciplinary team of rehabilitation physicians, neurologists, physiotherapists, occupational therapists, speech therapists and psychologists.'], features: ['national-public-hospital', 'neurological-rehabilitation', 'stroke-rehab', 'brain-injury', 'spinal-cord', 'multiple-sclerosis'], description: { it: 'Ospedale pubblico nazionale di Chisinau con programma multidisciplinare di riabilitazione neurologica per ictus, traumi cerebrali e midollari, SM, Parkinson e malattie neuromuscolari.', en: 'A national public hospital in Chisinau with a multidisciplinary neurological rehabilitation programme for stroke, brain and spinal trauma, MS, Parkinson disease and neuromuscular disease.' } },
  { id: 'sfanta-treime-neurorecuperare-chisinau', name: 'Sfanta Treime Municipal Clinical Hospital Neurorecuperare Unit', country: 'Moldova', city: 'Chisinau', region: 'Chisinau Municipality', lat: 47.0463, lng: 28.8591, address: 'Strada A. Russo 11, MD-2068 Chisinau', phone: '+373 22 441185', url: 'https://treime.md/departments/neurorecuperare/', conditions: ['stroke', 'tbi', 'spinal', 'neuromuscular', 'cognitive', 'neuromotor'], technologies: [], modes: ['inpatient'], access: ['public'], disciplines: ['Neurorecuperare', 'Neurology', 'Physical medicine and rehabilitation', 'Physiotherapy'], completeness: 90, researchHighlights: ['Official Sfanta Treime hospital page identifies a dedicated Neurorecuperare section operating since 2002.', 'The section focuses on restoring impaired functions and developing compensatory mechanisms to support independence and quality of life.'], features: ['public-hospital', 'neurorecuperare', 'inpatient-rehab'], description: { it: 'Unita pubblica ospedaliera di neurorecupero a Chisinau dedicata al ripristino delle funzioni compromesse e dell indipendenza.', en: 'A public hospital neurorecovery unit in Chisinau focused on restoring impaired functions and independence.' } },
  { id: 'karin-grech-rehabilitation-hospital-neurological-rehabilitation-pieta', name: 'Karin Grech Rehabilitation Hospital Neurological Rehabilitation', country: 'Malta', city: 'Pieta', region: 'Northern Harbour District', lat: 35.8886, lng: 14.4954, address: 'Guardamangia Hill, Pieta PTA 1312, Malta', phone: '+356 23441000', url: 'https://alliedhealthservices.gov.mt/en/professions/physiotherapy/physiotherapy-services/', conditions: ['stroke', 'tbi', 'spinal', 'ms', 'parkinson', 'neuromuscular', 'cognitive', 'neuromotor'], technologies: [], modes: ['inpatient', 'outpatient'], access: ['public'], disciplines: ['Neurological rehabilitation', 'Physical medicine and rehabilitation', 'Physiotherapy', 'Occupational therapy', 'Speech therapy', 'Nursing'], completeness: 95, researchHighlights: ['Official Malta health-service information identifies Karin Grech Rehabilitation Hospital as providing inpatient and outpatient neurorehabilitation.', 'Official hospital documentation describes specialist neurological inpatient rehabilitation for stroke, traumatic brain injury, spinal cord lesions, multiple sclerosis, Parkinson disease and other neurodegenerative disorders.'], features: ['national-rehabilitation-hospital', 'neurological-rehabilitation', 'inpatient-rehab', 'outpatient-rehab', 'stroke-rehab', 'brain-injury', 'spinal-cord', 'multiple-sclerosis'], description: { it: 'Ospedale pubblico di riabilitazione a Pieta con servizi di neuroriabilitazione degenziale e ambulatoriale per ictus, trauma cranico, lesioni midollari, SM e Parkinson.', en: 'A public rehabilitation hospital in Pieta with inpatient and outpatient neurorehabilitation for stroke, brain injury, spinal cord lesions, MS and Parkinson disease.' } },
  { id: 'ankara-gaziler-ftr-neurological-rehabilitation', name: 'Ankara Gaziler Physical Medicine and Rehabilitation Hospital Neurological Rehabilitation Unit', country: 'Turkey', city: 'Ankara', region: 'Ankara Province', lat: 39.8758, lng: 32.7589, address: 'Universiteler Mahallesi, Lodumlu Yolu 29 Ekim Sokak No: 1, Bilkent, Cankaya, Ankara', phone: '+90 312 2911000', url: 'https://gazilerftr.saglik.gov.tr/TR-646704/norolojik-rehabilitasyon-unitesi.html', conditions: ['stroke', 'tbi', 'spinal', 'neuromuscular', 'cognitive', 'neuromotor'], technologies: ['robotic-rehabilitation', 'gait-analysis'], modes: ['inpatient', 'outpatient'], access: ['public'], disciplines: ['Neurological rehabilitation', 'Physical medicine and rehabilitation', 'Physiotherapy', 'Occupational therapy', 'Nursing'], completeness: 96, researchHighlights: ['Official Ankara Gaziler FTR Hospital information identifies a neurological rehabilitation unit serving inpatients in the stroke, spinal cord injury and acute rehabilitation services.', 'Official hospital information describes a 210-bed rehabilitation clinic, early rehabilitation for spinal cord and traumatic brain injury, and dedicated stroke and spinal injury rehabilitation clinics.'], features: ['specialist-rehabilitation-hospital', 'neurological-rehabilitation', 'stroke-rehab', 'brain-injury', 'spinal-cord', 'robotic-rehabilitation'], description: { it: 'Ospedale pubblico specialistico di Ankara con unita di riabilitazione neurologica per ictus, lesioni midollari e trauma cranico.', en: 'A specialist public hospital in Ankara with neurological rehabilitation for stroke, spinal cord injury and traumatic brain injury.' } },
  { id: 'istanbul-ftr-eah-neurological-rehabilitation', name: 'Istanbul Physical Medicine and Rehabilitation Training and Research Hospital Neurological Rehabilitation', country: 'Turkey', city: 'Istanbul', region: 'Istanbul Province', lat: 41.0007, lng: 28.8425, address: 'Bahcelievler Mahallesi, Adnan Kahveci Bulvari No: 145, Bahcelievler, Istanbul', phone: '+90 212 4965000', url: 'https://istanbulftreah.saglik.gov.tr/TR-1171100/norolojik-rehabilitasyon-salonu.html', conditions: ['stroke', 'tbi', 'spinal', 'ms', 'parkinson', 'als', 'neuromuscular', 'cognitive', 'neuromotor'], technologies: [], modes: ['inpatient', 'outpatient'], access: ['public'], disciplines: ['Neurological rehabilitation', 'Physical medicine and rehabilitation', 'Physiotherapy'], completeness: 94, researchHighlights: ['Official Istanbul FTR Training and Research Hospital page describes a neurological rehabilitation service for impairments arising from central and peripheral nervous-system disease or injury.', 'The official page lists stroke, multiple sclerosis, Parkinson disease, ALS, traumatic brain injury, spinal cord injury, cerebral palsy and neuromuscular disease.'], features: ['specialist-rehabilitation-hospital', 'neurological-rehabilitation', 'stroke-rehab', 'brain-injury', 'spinal-cord', 'multiple-sclerosis'], description: { it: 'Ospedale pubblico universitario di Istanbul con riabilitazione neurologica per ictus, trauma cranico, lesioni midollari, SM, Parkinson e ALS.', en: 'A public training and research hospital in Istanbul providing neurological rehabilitation for stroke, brain injury, spinal cord injury, MS, Parkinson disease and ALS.' } },
  { id: 'giresun-ftr-centre-neurological-rehabilitation', name: 'Giresun Physical Therapy and Rehabilitation Centre Neurological Rehabilitation Unit', country: 'Turkey', city: 'Giresun', region: 'Giresun Province', lat: 40.9147, lng: 38.4105, address: 'Teyyareduzu Mahallesi, Ataturk Bulvari No: 325, Merkez, Giresun', phone: '+90 454 2444444', url: 'https://giresunftr.saglik.gov.tr/TR-552841/norolojik-rehabilitasyon-salonu.html', conditions: ['stroke', 'spinal', 'ms', 'parkinson', 'alzheimer', 'neuromuscular', 'neuromotor'], technologies: ['robotic-rehabilitation'], modes: ['inpatient'], access: ['public'], disciplines: ['Neurological rehabilitation', 'Physical medicine and rehabilitation', 'Physiotherapy'], completeness: 93, researchHighlights: ['Official Giresun FTR Centre page describes a 600-square-metre neurological rehabilitation unit staffed by 13 physiotherapists.', 'The unit treats spinal cord injury, stroke, muscle disease, multiple sclerosis, Parkinson disease and Alzheimer disease, and includes upper-limb robotic rehabilitation equipment.'], features: ['specialist-rehabilitation-centre', 'neurological-rehabilitation', 'stroke-rehab', 'spinal-cord', 'robotic-rehabilitation', 'multiple-sclerosis'], description: { it: 'Centro pubblico di riabilitazione a Giresun con unita neurologica per ictus, lesioni midollari, SM, Parkinson e malattie muscolari, dotata di robotica per arto superiore.', en: 'A public rehabilitation centre in Giresun with a neurological unit for stroke, spinal cord injury, MS, Parkinson disease and muscle disease, including upper-limb rehabilitation robotics.' } },
  { id: 'hacettepe-neurological-rehabilitation-unit-ankara', name: 'Hacettepe University Neurological Rehabilitation Unit', country: 'Turkey', city: 'Ankara', region: 'Ankara Province', lat: 39.9334, lng: 32.8669, address: 'Hacettepe University Faculty of Health Sciences, Physiotherapy and Rehabilitation Department, 06100 Ankara', phone: '+90 312 3052525', url: 'https://www.nru.hacettepe.edu.tr/tr/hakkimizda', conditions: ['stroke', 'ms', 'parkinson', 'als', 'neuromuscular', 'cognitive', 'neuromotor'], technologies: [], modes: ['outpatient'], access: ['public'], disciplines: ['Neurological rehabilitation', 'Physiotherapy', 'Physical medicine and rehabilitation'], completeness: 91, researchHighlights: ['Official Hacettepe University page identifies the Neurological Rehabilitation Unit as a national reference centre that accepts patients from across Turkey.', 'The unit provides physiotherapy and rehabilitation for neuromuscular disease, stroke, multiple sclerosis, Parkinson disease and motor neuron disease.'], features: ['university-reference-centre', 'neurological-rehabilitation', 'outpatient-rehab', 'stroke-rehab', 'multiple-sclerosis', 'parkinson'], description: { it: 'Unita universitaria di riferimento nazionale ad Ankara per la riabilitazione neurologica ambulatoriale in ictus, SM, Parkinson, malattie neuromuscolari e del motoneurone.', en: 'A national university reference unit in Ankara for outpatient neurological rehabilitation in stroke, MS, Parkinson disease, neuromuscular and motor neuron disease.' } },
  { id: 'kocaeli-city-hospital-neurological-rehabilitation', name: 'Kocaeli City Hospital Neurological Rehabilitation', country: 'Turkey', city: 'Izmit', region: 'Kocaeli Province', lat: 40.7667, lng: 29.9711, address: 'Tavsantepe Mahallesi, Akif Sokak No: 72, Izmit, Kocaeli', phone: '+90 262 2252700', url: 'https://kocaelisehir.saglik.gov.tr/TR-1302150/norolojik-rehabilitasyon.html', conditions: ['stroke', 'tbi', 'spinal', 'ms', 'parkinson', 'als', 'neuromuscular', 'cognitive', 'neuromotor'], technologies: [], modes: ['inpatient', 'outpatient'], access: ['public'], disciplines: ['Neurological rehabilitation', 'Physical medicine and rehabilitation', 'Physiotherapy'], completeness: 93, researchHighlights: ['Official Kocaeli City Hospital page describes neurological rehabilitation for motor, sensory, balance, coordination and cognitive impairments after central or peripheral nervous-system disease or injury.', 'The service explicitly covers stroke, traumatic brain injury, spinal cord injury, multiple sclerosis, Parkinson disease, ALS, cerebral palsy and peripheral nerve injury.'], features: ['city-hospital', 'neurological-rehabilitation', 'stroke-rehab', 'brain-injury', 'spinal-cord', 'multiple-sclerosis'], description: { it: 'Servizio pubblico di neuroriabilitazione presso il City Hospital di Kocaeli per ictus, trauma cranico, lesioni midollari, SM, Parkinson e ALS.', en: 'A public neurological rehabilitation service at Kocaeli City Hospital for stroke, brain injury, spinal cord injury, MS, Parkinson disease and ALS.' } },
  { id: 'mary-free-bed-rehabilitation-hospital-grand-rapids', name: 'Mary Free Bed Rehabilitation Hospital', country: 'United States', city: 'Grand Rapids', region: 'Michigan', lat: 42.9556, lng: -85.6609, address: '235 Wealthy Street SE, Grand Rapids, MI 49503', phone: '+1 616 8408000', url: 'https://www.maryfreebed.com/specialties/brain-injury-rehabilitation', conditions: ['stroke', 'tbi', 'spinal', 'ms', 'parkinson', 'neuromuscular', 'cognitive', 'neuromotor'], technologies: ['assistive-tech'], modes: ['inpatient', 'outpatient'], access: ['private', 'insurance'], disciplines: ['Neurological rehabilitation', 'Physical medicine and rehabilitation', 'Neuropsychology', 'Nursing', 'Physiotherapy', 'Occupational therapy', 'Speech therapy'], completeness: 94, researchHighlights: ['Official Mary Free Bed information identifies CARF-accredited inpatient and outpatient brain injury rehabilitation programmes staffed by specialist physicians, therapists and nurses.', 'Its rehabilitation hospital provides multidisciplinary inpatient and outpatient care for brain injury, spinal cord injury and stroke.'], features: ['specialist-rehabilitation-hospital', 'neurological-rehabilitation', 'brain-injury', 'spinal-cord', 'stroke-rehab', 'inpatient-rehab', 'outpatient-rehab'], description: { it: 'Ospedale specialistico di riabilitazione nel Michigan con programmi multidisciplinari per lesioni cerebrali, lesioni midollari e ictus.', en: 'A specialist rehabilitation hospital in Michigan with multidisciplinary programmes for brain injury, spinal cord injury and stroke.' } },
  { id: 'rusk-rehabilitation-nyu-langone-orthopedic-hospital', name: 'Rusk Rehabilitation at NYU Langone Orthopedic Hospital', country: 'United States', city: 'New York', region: 'New York', lat: 40.7338, lng: -73.9866, address: '301 East 17th Street, New York, NY 10003', phone: '+1 212 2636034', url: 'https://nyulangone.org/locations/rusk-rehabilitation-at-nyu-langone-orthopedic-hospital', conditions: ['stroke', 'tbi', 'spinal', 'ms', 'parkinson', 'neuromuscular', 'cognitive', 'neuromotor'], technologies: [], modes: ['inpatient', 'outpatient'], access: ['private', 'insurance'], disciplines: ['Neurological rehabilitation', 'Physical medicine and rehabilitation', 'Neuropsychology', 'Nursing', 'Physiotherapy', 'Occupational therapy', 'Speech therapy'], completeness: 95, researchHighlights: ['Official NYU Langone information identifies Rusk Rehabilitation as an inpatient and outpatient service for traumatic and non-traumatic brain injury, chronic neurological conditions, spinal cord injury and stroke.', 'The Neurologic Rehabilitation division provides specialised clinical programmes for brain, spinal cord and peripheral nerve injuries and degenerative conditions including Parkinson disease and multiple sclerosis.'], features: ['university-hospital', 'neurological-rehabilitation', 'brain-injury', 'spinal-cord', 'stroke-rehab', 'multiple-sclerosis', 'research'], description: { it: 'Servizio universitario di neuroriabilitazione a New York per lesioni cerebrali e midollari, ictus e malattie neurologiche croniche.', en: 'A university neurological rehabilitation service in New York for brain and spinal cord injury, stroke and chronic neurological conditions.' } },
  { id: 'rancho-los-amigos-national-rehabilitation-center-downey', name: 'Rancho Los Amigos National Rehabilitation Center', country: 'United States', city: 'Downey', region: 'California', lat: 33.9185, lng: -118.1315, address: '7601 Imperial Highway, Downey, CA 90242', phone: '+1 562 3857111', url: 'https://dhs.lacounty.gov/rancho/patient-and-visitor/admissions-appointments/frequently-asked-questions/', conditions: ['stroke', 'tbi', 'spinal', 'ms', 'parkinson', 'neuromuscular', 'cognitive', 'neuromotor'], technologies: ['assistive-tech'], modes: ['inpatient', 'outpatient'], access: ['public'], disciplines: ['Neurological rehabilitation', 'Neurology', 'Physical medicine and rehabilitation', 'Nursing', 'Physiotherapy', 'Occupational therapy', 'Speech therapy'], completeness: 96, researchHighlights: ['Official Los Angeles County information describes Rancho Los Amigos as a world-renowned neurorehabilitation programme serving people with stroke, brain injury, spinal cord injury and other neurological conditions.', 'The public centre provides inpatient and outpatient rehabilitation at one of the largest rehabilitation hospitals in the United States, alongside clinical research and assistive-technology services.'], features: ['public-rehabilitation-hospital', 'neurological-rehabilitation', 'brain-injury', 'spinal-cord', 'stroke-rehab', 'assistive-technology', 'research'], description: { it: 'Centro pubblico nazionale di riabilitazione nella contea di Los Angeles per ictus, lesioni cerebrali e midollari e altre condizioni neurologiche.', en: 'A public national rehabilitation centre in Los Angeles County for stroke, brain and spinal cord injury, and other neurological conditions.' } }
];
