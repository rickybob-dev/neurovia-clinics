...
const explicitNeuroRehabSignals = [
  ...
  'neurorevalidatie',
  'neurorehabilitace',
  'intenzivní neurorehabilitační',
  'rehabilitačně neurologická',
  'rehabilitačně-neurologická',
  'spinální rehabilitační',
  'neurorehabilitacja',
  ...
  'rehabilitácia neurologických',
  'spinálnej rehabilitačnej',
...
const neuroSignals = [
  ...
  'detska mozkova obrna',
  'mozková obrna',
  'mozkova obrna',
  'neurologické diagnózy',
  'neurologicke diagnozy',
  ...
  'kõneraskused',
  'koneraskused',
  'närvide düsfunktsioonid',
  'narvide dusfunktsioonid',
